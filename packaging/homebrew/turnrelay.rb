class Turnrelay < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/romanrublev/turnrelay/releases/download/v0.4.0-beta/turnrelay-darwin-arm64.tar.gz"
      sha256 "b3f53f7bc36d46fcce899ba32a0a7a1777334caed93b27bfe78257edb6ffeba3"
    end
  end
